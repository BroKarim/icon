  ...
  <div class="pointer-events-none absolute inset-x-0 top-0 z-[999] px-4 pt-4">
    <div class="mx-auto flex justify-between w-full items-center gap-3 rounded-[30px]">
      ...
      <div class="pointer-events-auto px-4 py-3 flex items-center gap-2 shrink-0">
        ...
        <button
          type="button"
          class="relative inline-flex items-center justify-center h-10 w-10 rounded-full cursor-pointer bg-background/80 border border-[#222]/20 p-1 shadow-sm backdrop-blur hover:bg-white/20 transition-colors"
          @click="showBag = true"
        >
